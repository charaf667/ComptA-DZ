/**
 * Types pour le système de versionnage des documents
 * Inspiré des principes Git pour une gestion efficace des versions
 */
...
export interface VersionDiffResponse {
  fromVersion: number;         // Numéro de la version de départ
  toVersion: number;           // Numéro de la version d'arrivée
  documentId: string;          // ID du document
  changes: DocumentChange[];   // Liste des changements entre les deux versions
  createdAt: string;           // Date de création de la version d'arrivée
  createdBy: string;           // Créateur de la version d'arrivée
}
