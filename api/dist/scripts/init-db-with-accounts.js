...
async function initializeDatabase() {
    ...
    try {
        ...
        if (!existingAdmin) {
            ...
            const hashedPassword = await (0, bcryptjs_1.hash)('Admin@123', 10); // Mot de passe par défaut
        ...
        if (existingAccounts > 0) {
            ...
            const defaultAccounts = [
                ...
                { code: '101', label: 'Capital social', classe: 1, type: client_1.TypeCompte.CREDIT, category: client_1.CategorieCompte.DETAIL },
                { code: '106', label: 'Réserves', classe: 1, type: client_1.TypeCompte.CREDIT, category: client_1.CategorieCompte.DETAIL },
