...
const document_collaboration_routes_1 = __importDefault(require("./document-collaboration.routes"));
...
router.use('/collaboration', document_collaboration_routes_1.default);
